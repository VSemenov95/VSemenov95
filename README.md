# Привет, я Владислав! 👋
***QA fullstack Engineer (Java)***

Помогу вашему приложению обрести качество: как функциональное, так и нефункциональное.  За плечами 7 лет опыта в IT. Выполнял роли: QA manual, QA lead, ЦК QA, PM, AQA.

На текущий момент держу вектор развития на автоматизацию (Web, Mobile и API), а также ИИ и его применение в тестировании.

Рабочий девиз: не существует плавающих багов, есть плохо локализованные.
...
## 🚀 Основные проекты
- ***[UI tests на примере учебного тренажера Яндекс.Самокат](https://github.com/VSemenov95/ya_samokat_ui_tests)***
...
- ***[Mobile tests for Android на примере Wiki](https://github.com/VSemenov95/Wiki_mobile_tests)***
...
- ***[API & UI tests на примере учебного тренажера BookClub](https://github.com/VSemenov95/book_club_tests)***
...
**Browserstack:** Облачная платформа для тестирования веб-сайтов и мобильных приложений
